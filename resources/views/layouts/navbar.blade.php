...
<nav class="navbar navbar-expand-lg main-navbar">
  ...
  <ul class="navbar-nav navbar-right">
    ...
    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
        <img alt="image" src="{{ Auth::user()->avatar ?? asset('assets/img/avatar/avatar-1.png') }}"
      ...
      <div class="dropdown-menu dropdown-menu-right">
        ...
        <a href="#" class="dropdown-item has-icon text-danger" onclick="confirmLogout(event)">
        ...
        <script>
          function confirmLogout(event) {
            ...
            Swal.fire({
              title: 'Mau keluar ?',
              text: "Pastikan pekerjaan kamu sudah disimpan ya!",
              icon: 'warning',
              showCancelButton: true,
              confirmButtonColor: '#6777ef', // Warna biru khas Stisla
